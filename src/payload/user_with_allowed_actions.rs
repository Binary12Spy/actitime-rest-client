...
pub struct UserWithAllowedActions {
...
impl UserWithAllowedActions {
    ...
    pub fn with_allowed_actions(mut self, allowed_actions: AllowedActions) -> Self {
...
impl From<User> for UserWithAllowedActions {
    fn from(user: User) -> Self {
        UserWithAllowedActions {
            id: user.id,
            department_id: user.department_id,
            time_zone_group_id: user.time_zone_group_id,
            hired: user.hired,
